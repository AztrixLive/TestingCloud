...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/testingcloud)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/testingcloud
```

A live public deployment of this template is available at [https://testingcloud.templates.workers.dev](https://testingcloud.templates.workers.dev)
